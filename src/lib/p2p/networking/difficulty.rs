...
pub 
fn get_target_from_diff_units(diff: u64) -> U256 {
    DIFF1.checked_div(&U256::from_u64(diff)).unwrap().saturating_mul(&PPLNS_SHARE_UNITS_256)
}
...
mod tests {
    ...
    use crate::p2p::networking::difficulty::get_diff1_score;
    ...
    fn bitcoin_diff() {
        ...
        let result = get_diff1_score(&check);
